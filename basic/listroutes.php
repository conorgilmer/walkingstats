...
if ($result) {
	...
	while ($route = mysql_fetch_assoc($result))
	{
		...
		$htmlString .=  "<td>";
		$htmlString .=  output_route_distance($route["id"]);
		$htmlString .=  "</td>";
		
                
		$htmlString .=  "<td>";
		$htmlString .=  output_route_time($route["id"]);
		$htmlString .=  "</td>";
		
		
		$htmlString .=  "<td>";
		$htmlString .=  output_edit_route_link($route["id"]);
		$htmlString .=  "</td>";
		
		$htmlString .=  "<td>";
		$htmlString .=  output_delete_route_link($route["id"]);
		$htmlString .=  "</td>";
